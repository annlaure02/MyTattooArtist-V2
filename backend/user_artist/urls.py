...
urlpatterns = [
    ...
    path('api/ma-page-artiste/<str:artist_id>/delete-album/<str:album_id>/',
         views.delete_artist_album),
    path('api/ma-page-artiste/<str:artist_id>/delete-flash/<str:flash_id>/',
         views.delete_artist_flash),
