...
function Status({ dataUpdated, artist }) {
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <Modal.Body>
              <div className='form-container-artist'>
                <FloatingLabel controlId="status" label="Votre status" className="mb-3">
                  <Form.Select aria-label="Floating label select example" placeholder="" {...register('status')}>
                    <option>Sélectionner votre status</option>
