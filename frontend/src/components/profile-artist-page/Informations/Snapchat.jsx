...
function Snapchat({ dataUpdated, artist }) {
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <Modal.Body>
              <div className='form-container-artist'>
                <FloatingLabel controlId="snapchat" label="snapchat" className="mb-3">
                  <Form.Control type="text" placeholder="" {...register('snapchat')} />
                </FloatingLabel>
